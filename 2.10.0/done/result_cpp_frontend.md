...
#### Stable ABI
- Upgraded stable `new_{empty/zeros}` that had only `dtype` argument to full version ([#169711](https://github.com/pytorch/pytorch/pull/169711))
- Added `torch::stable::Device` ([#166579](https://github.com/pytorch/pytorch/pull/166579))
- Added `stable::Tensor.device()` ([#166694](https://github.com/pytorch/pytorch/pull/166694))
- Added `parallel_for` to `torch/csrc/stable` ([#166695](https://github.com/pytorch/pytorch/pull/166695))
- Added string support for ABI stable custom ops ([#168370](https://github.com/pytorch/pytorch/pull/168370))
- Added `element_size`, `storage_offset` and `set_requires_grad` to `stable::Tensor` ([#169703](https://github.com/pytorch/pytorch/pull/169703))
- Added `sum` and `sum_out` to stable ops ([#168062](https://github.com/pytorch/pytorch/pull/168062))
- Added stable shim for `at::get_num_threads` ([#167362](https://github.com/pytorch/pytorch/pull/167362))
- Added `empty` to stable ops ([#167592](https://github.com/pytorch/pytorch/pull/167592))
- Added `reshape`, `view`, `flatten` to `torch/csrc/stable` ([#167600](https://github.com/pytorch/pytorch/pull/167600))
- Added shim for `getCurrentBlasHandle` ([#168276](https://github.com/pytorch/pytorch/pull/168276))
- Added C++ wrapper for shim `from_blob` in `stable/csrc/ops.h` ([#168380](https://github.com/pytorch/pytorch/pull/168380))
- Added `to` and `contiguous` to stable ops ([#169709](https://github.com/pytorch/pytorch/pull/169709))
- Added `TORCH_TARGET_VERSION` for stable ABI ([#164356](https://github.com/pytorch/pytorch/pull/164356))
...
- Remove unused exception parameter from caffe2/caffe2/serialize/inline_container.cc ([#167612](https://github.com/pytorch/pytorch/pull/167612))
...
- Added `STD_CUDA_{KERNEL_LAUNCH_}CHECK` ([#169385](https://github.com/pytorch/pytorch/pull/169385))
...
- Fixed #164742, all header-impl'd userfacing functions should be inline ([#164871](https://github.com/pytorch/pytorch/pull/164871))
### security
