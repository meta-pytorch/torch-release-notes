...
- [ROCm] Integrate AITER Fav3 fwd kernels ([#160105](https://github.com/pytorch/pytorch/pull/160105))
- Revert "[dynamo] Graph break on on user-defined class in compiled region (a3e26d17274)
- Revert "[ROCm] Add specific compile options for CK SDPA (2281d009e5e)
...
- [dynamo] Graph break on on user-defined class in compiled region ([#161670](https://github.com/pytorch/pytorch/pull/161670))
- Revert "[ROCm] Integrate AITER Fav3 fwd kernels (96ef26f71ae)
...
- Revert "[ROCm/Windows] Support aotriton for scaled_dot_product_attention on Windows. (5b9114bf197)
- [DeviceMesh] Make CuTe layout as mesh layout to be ready for using in DeviceMesh ([#162414](https://github.com/pytorch/pytorch/pull/162414))
...
- Revert "[ROCm] Remove HIPBLASLT_ALLOW_TF32 from codebase (66308fb4707)
...
- Revert "[ROCm] Bump FBGEMM commit to avoid CK errors (607469bdad9)
...
- [ROCm] new implementation of upsample_bilinear2d_backward ([#164572](https://github.com/pytorch/pytorch/pull/164572))
- [ATen] Fix CUDA reduction warp shuffle order ([#164790](https://github.com/pytorch/pytorch/pull/164790))
...
- Revert "[ROCm] new implementation of upsample_bilinear2d_backward (faff826a46c)
...
- Revert "[ROCm][CI] Update rocm.yml workflow to use 1 GPU ARC runners (4f7f43253d8)
- Revert "[Inductor] Naive foreach autotune support (cf280ca1e82)
- [1/N] Change C-style casts to static_cast or reinterpret_cast ([#165750](https://github.com/pytorch/pytorch/pull/165750))
- [ATen] Fix CUDA reduction warp shuffle order ([#164790](https://github.com/pytorch/pytorch/pull/164790))
- Revert "[ROCm][CI] Update rocm.yml workflow to use 1 GPU ARC runners (21131a24443)
...
- [Inductor] support masked vectorization for the tail_loop for float64 datatype ([#163316](https://github.com/pytorch/pytorch/pull/163316))
- [ROCm] Enable group gemm through CK ([#166334](https://github.com/pytorch/pytorch/pull/166334))
...
- Revert "[ROCm] Enable group gemm through CK (35f3572fa48)
...
- Revert "[ROCm] Enable StaticCudaLauncher for ROCm (b228f6d1809)
...
- Revert "[ROCm][CI] Update docker-cache-mi300.yml to test MI300 CI docker caching (f44a1ddcb2e)
- Revert "[Inductor] Naive foreach autotune support (56034074ca1)
- Revert "[ROCm][CI] Update docker-cache-mi300.yml to test MI300 CI docker caching (051f1fe8e39)
...
- [ARM] Improve LLM performance & mem usage using int4-bf16 KleidiAI kernels ([#158250](https://github.com/pytorch/pytorch/pull/158250))
- [ROCm] enable fastSpecializedAtomicAdd for gfx950 ([#167661](https://github.com/pytorch/pytorch/pull/167661))
...
- Revert "[ROCm] Enable StaticCudaLauncher for ROCm (ae3ce54f27a)
- Revert "[ROCm][CI] Upgrade ROCm CI to 7.1 (694f9b943c1)
...
- Improve char printing ([#167899](https://github.com/pytorch/pytorch/pull/167899))
- Revert "[ROCm] enable fastSpecializedAtomicAdd for gfx950 (d91269e8ce3)
- distributed/debug: add an HTTP server for debugging running jobs ([#167395](https://github.com/pytorch/pytorch/pull/167395))
...
- [Inductor XPU GEMM] Step 1/N: Refactor cutlass configuration. ([#160174](https://github.com/pytorch/pytorch/pull/160174))
- [inductor] require shape in TritonCSEVariable ([#162275](https://github.com/pytorch/pytorch/pull/162275))
- Revert "[ROCm] Enable StaticCudaLauncher for ROCm (6f4baa5abe3)
...
- [ROCm][CI] skip test_max_autotune until resolved ([#162496](https://github.com/pytorch/pytorch/pull/162496))
...
- [ROCm] Add specific compile options for CK SDPA ([#161759](https://github.com/pytorch/pytorch/pull/161759))
...
- [ROCm][CI] unskip some test_memory_format tests ([#162766](https://github.com/pytorch/pytorch/pull/162766))
...
- [ROCm] enable aoti tests, forward fix 162353 ([#162827](https://github.com/pytorch/pytorch/pull/162827))
- [inductor] FlexibleLayout for ExternKernelChoice for mms ([#161351](https://github.com/pytorch/pytorch/pull/161351))
- [inductor] leverage template stacking in V.choices.get_mm_configs ([#161350](https://github.com/pytorch/pytorch/pull/161350))
- [inductor][choices] rename get_mm_configs to get_template_configs ([#162293](https://github.com/pytorch/pytorch/pull/162293))
...
- [ROCm][benchmark] Add HF LLM benchmark expected accuracy ([#162965](https://github.com/pytorch/pytorch/pull/162965))
- AMD CPU CI - Add freezing + fix label trigger ([#162176](https://github.com/pytorch/pytorch/pull/162176))
- [ROCm] fix conv relu fusion ([#162856](https://github.com/pytorch/pytorch/pull/162856))
...
- [ROCm] Remove HIPBLASLT_ALLOW_TF32 from codebase ([#162998](https://github.com/pytorch/pytorch/pull/162998))
...
- [ROCm] Remove HIPBLASLT_ALLOW_TF32 from codebase ([#162998](https://github.com/pytorch/pytorch/pull/162998))
- [ROCm] test_aot_inductor: Enable fp8 tests. ([#163050](https://github.com/pytorch/pytorch/pull/163050))
...
- [ROCm] update ci_expected_accuracy for dynamo benchmarks ([#163256](https://github.com/pytorch/pytorch/pull/163256))
...
- [ROCm] Bump FBGEMM commit to avoid CK errors ([#162590](https://github.com/pytorch/pytorch/pull/162590))
...
- [ROCm] Fix mx fp8 and fp4 code after scaling refactor changes. ([#163127](https://github.com/pytorch/pytorch/pull/163127))
...
- [ROCm] Fix environment variable AOTRITON_INSTALLED_PREFIX ([#163373](https://github.com/pytorch/pytorch/pull/163373))
...
- [ROCm][CI] cudagraph trees ut fixes ([#163592](https://github.com/pytorch/pytorch/pull/163592))
...
- [ROCm][CI] skip test_sparse_triangular_solve ([#163651](https://github.com/pytorch/pytorch/pull/163651))
- [EZ] Perma-ignore UP038 ([#163649](https://github.com/pytorch/pytorch/pull/163649))
- [ROCm] Build FBGEMM_GENAI for gfx942 only ([#162648](https://github.com/pytorch/pytorch/pull/162648))
...
- [ROCm][CI] skip TestCudaPrimaryCtx.test_set_device_0 ([#163693](https://github.com/pytorch/pytorch/pull/163693))
...
- [ROCm][CI] adjust tf32 tolerance for test_compile_kernel_advanced ([#163783](https://github.com/pytorch/pytorch/pull/163783))
...
- Revert "enable test_sampled_addmm_zero_sized_cuda for rocm (#121940)" ([#163848](https://github.com/pytorch/pytorch/pull/163848))
...
- Skip test_conv3d_cudnn_broken on ROCM ([#164138](https://github.com/pytorch/pytorch/pull/164138))
...
- [ROCm][CI] fix test_cudnn_convolution_relu_cuda ([#164466](https://github.com/pytorch/pytorch/pull/164466))
- Stop parsing command line arguments every time common_utils is imported. ([#156703](https://github.com/pytorch/pytorch/pull/156703))
...
- [ROCm] Enabled JIT UTs on ROCm ([#164582](https://github.com/pytorch/pytorch/pull/164582))
...
- [ROCm][CI] test_convolution.py uses miopen immediate mode ([#164598](https://github.com/pytorch/pytorch/pull/164598))
...
- [ROCm] hotfix test scaled matmul cuda ([#165104](https://github.com/pytorch/pytorch/pull/165104))
- Fix truediv numerics between eager and compile ([#164144](https://github.com/pytorch/pytorch/pull/164144))
...
- [ROCm] Add more timm models, forward fix #165381 ([#165569](https://github.com/pytorch/pytorch/pull/165569))
...
- ROCm unit tests enablement ([#165366](https://github.com/pytorch/pytorch/pull/165366))
...
- [ROCm][CI] Update rocm.yml workflow to use 1 GPU ARC runners ([#165481](https://github.com/pytorch/pytorch/pull/165481))
...
- [ROCm] Keep amdgpu-coerce-illegal-types flag if rocm version is less than 7.2 ([#165789](https://github.com/pytorch/pytorch/pull/165789))
- [ROCm][CI] Update rocm.yml workflow to use 1 GPU ARC runners ([#165481](https://github.com/pytorch/pytorch/pull/165481))
- [dynamo][misc] Replace UserFunctionVariable with VariableTracker build ([#165707](https://github.com/pytorch/pytorch/pull/165707))
...
- [ROCm] fix test_allocator_backend ([#166035](https://github.com/pytorch/pytorch/pull/166035))
- [ROCm] Skip test_blockwise_nvfp4_with_global_scale ([#165968](https://github.com/pytorch/pytorch/pull/165968))
...
- [ROCm] Use a ROCm version string without hash. ([#166336](https://github.com/pytorch/pytorch/pull/166336))
...
- [ROCm][CI] forward fix kineto submodule bump ([#166421](https://github.com/pytorch/pytorch/pull/166421))
...
- [ROCm] moved gfx1100 back to experimental status for AOTriton ([#166397](https://github.com/pytorch/pytorch/pull/166397))
- [BE] Move GreenContext implementation details to cpp ([#166462](https://github.com/pytorch/pytorch/pull/166462))
...
- [ROCm] Skip nvfp4 tests on ROCm ([#167066](https://github.com/pytorch/pytorch/pull/167066))
...
- [ROCm]  Disable group gemm CK path when composable kernel (CK) is not enabled ([#167403](https://github.com/pytorch/pytorch/pull/167403))
...
- [ROCm][CI] Update docker-cache-mi300.yml to test MI300 CI docker caching ([#167554](https://github.com/pytorch/pytorch/pull/167554))
- [ROCm][CI] Update docker-cache-mi300.yml to test MI300 CI docker caching ([#167554](https://github.com/pytorch/pytorch/pull/167554))
- [DebugMode] record triton kernels, run-to-run determinism checks ([#167028](https://github.com/pytorch/pytorch/pull/167028))
- [ROCm][CI] Add docker-cache-rocm.yml to test MI3xx CI docker caching ([#167554](https://github.com/pytorch/pytorch/pull/167554))
- [ROCm][CI] dynamo benchmarks update ci expected accuracy ([#167574](https://github.com/pytorch/pytorch/pull/167574))
...
- [ROCm][CI] forward fix libtorch agnostic tests ([#168087](https://github.com/pytorch/pytorch/pull/168087))
...
- [ROCm] Fix HIP document url. ([#168220](https://github.com/pytorch/pytorch/pull/168220))
...
- Remove outdated flaky models and enable deterministic algorithms on ROCm ([#169024](https://github.com/pytorch/pytorch/pull/169024))
...
- [ROCm] Bump to aotriton 0.11.1b ([#169696](https://github.com/pytorch/pytorch/pull/169696))
