...
- [ROCm] Origami integration for AMD GEMM selection ([#172512](https://github.com/pytorch/pytorch/pull/172512))
...
- [ROCm] [CI] Set MIOPEN_FIND_MODE=FAST in op benchmark CI to prevent cold-cache timeout ([#179795](https://github.com/pytorch/pytorch/pull/179795))
...
- [ROCm][CI] add gfx1103 to magma, remove ROCm 7 build ([#179788](https://github.com/pytorch/pytorch/pull/179788))
- ci: add torchcomms to distributed CI ([#181662](https://github.com/pytorch/pytorch/pull/181662))
...
- [ROCm][CI] Stop setting CUDA_VISIBLE_DEVICES on ROCm ([#183622](https://github.com/pytorch/pytorch/pull/183622))
