...
## build_frontend
### bc breaking
- [Build] Strengthen SVE compile check in FindARM.cmake ([#176646](https://github.com/pytorch/pytorch/pull/176646))
### deprecation
### new features
### improvements
- [BE] Simplify SVE256 detection ([#176247](https://github.com/pytorch/pytorch/pull/176247))
- [BE] Remove lots of ARMv7 checks ([#176645](https://github.com/pytorch/pytorch/pull/176645))
### bug fixes
- [Build] Update TORCH_BUILD_VERSION when version.txt changes ([#176167](https://github.com/pytorch/pytorch/pull/176167))
### performance
### docs
### devs
### Untopiced
