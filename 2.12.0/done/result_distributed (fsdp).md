...
# Release Notes worksheet distributed (fsdp)
...
### Untopiced
### not user facing
- Python 3.10 typing updates in distributed/FSDP-adjacent code ([#170280](https://github.com/pytorch/pytorch/pull/170280))
- Reverted or superseded FSDP/Dynamo support changes with no standalone release-note entry ([#169415](https://github.com/pytorch/pytorch/pull/169415), [#170667](https://github.com/pytorch/pytorch/pull/170667), [#176613](https://github.com/pytorch/pytorch/pull/176613), [#178223](https://github.com/pytorch/pytorch/pull/178223))
...
- Use `()` instead of `tuple()` for a small internal cleanup ([#175492](https://github.com/pytorch/pytorch/pull/175492))
### security
