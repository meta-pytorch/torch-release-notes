...
- Refactor Inductor autotune subprocess device-visibility handling to use `ZE_AFFINITY_MASK` on XPU ([#183436](https://github.com/pytorch/pytorch/pull/183436))
...
- Check memory granularity alignment in `ExpandableSegment` for XPU ([#188148](https://github.com/pytorch/pytorch/pull/188148))
...
- Move `MemPool` from c10 to ATen for XPU, aligning with CUDA ([#192032](https://github.com/pytorch/pytorch/pull/192032))
