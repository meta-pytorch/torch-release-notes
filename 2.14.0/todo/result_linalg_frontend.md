...
- [ROCm] Enable cholesky_ex via hipSOLVER xgeev (ROCm >= 7.14) & remove Magma dependency for autogenerated tests ([#188720](https://github.com/pytorch/pytorch/pull/188720))
